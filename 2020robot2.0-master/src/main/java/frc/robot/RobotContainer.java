...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    //new JoystickButton(joystick,     Button.emergencyshooter)     .whenPressed(new InstantCommand(()->m_shooter.emergencyshot()).andThen(new WaitCommand(2).andThen(new InstantCommand(()->m_shooter.emergencyconyor())))).whenReleased(new InstantCommand(()->m_shooter.stopall()));
